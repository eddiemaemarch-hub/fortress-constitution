...
- [project_position_audit_fix.md](project_position_audit_fix.md) — Position audit fixed to recognize Trader2/3 state files + use shared telegram module (2026-03-25)
