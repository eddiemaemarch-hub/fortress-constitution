---
name: Music Library
description: 49 mp3 tracks in ~/Music used by the video editor workflow (meta_video_editor.py + video_config.yaml)
type: reference
---
...
### Tracks (49 total, as of 2026-04-30)

- 8ball_mjg_thingz.mp3
...
### Playlist
- `~/Music/rudy_playlist.m3u` — flat playlist of all tracks in alphabetical order.

### Notes
- `ti_war.mp3` is ~1MB — may be a short/partial version.
- `*_alt.mp3` files are alternate cuts of the primary track.
- Referenced by filename only in `video_config.yaml` — keep names stable.
