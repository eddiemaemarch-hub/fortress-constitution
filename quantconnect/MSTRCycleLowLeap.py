...
# MSTR Cycle-Low LEAP Entry Strategy Backtest v2.5 Production
#
...
# RE-ENTRY: Allowed after stop-out (cycle lock removed on exit — catches full bull runs)
...
class MSTRCycleLowLeap(QCAlgorithm):
    ...
    def OnEndOfAlgorithm(self):
        ...
        self.Log("=" * 60)
        self.Log(f"MSTR CYCLE-LOW LEAP v2.5 ({res_name})")
        self.Log("=" * 60)
